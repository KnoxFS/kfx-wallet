...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* KnoxFS features */
        {"kfx", "listmasternodes", &listmasternodes, true, true, false},
        {"kfx", "getmasternodecount", &getmasternodecount, true, true, false},
        {"kfx", "masternodeconnect", &masternodeconnect, true, true, false},
        {"kfx", "masternodecurrent", &masternodecurrent, true, true, false},
        {"kfx", "masternodedebug", &masternodedebug, true, true, false},
        {"kfx", "startmasternode", &startmasternode, true, true, false},
        {"kfx", "createmasternodekey", &createmasternodekey, true, true, false},
        {"kfx", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"kfx", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"kfx", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"kfx", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"kfx", "getmasternodescores", &getmasternodescores, true, true, false},
        {"kfx", "mnsync", &mnsync, true, true, false},
        {"kfx", "spork", &spork, true, true, false},
        {"kfx", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use kfxd, or the -server option to kfx-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> kfx-cli " + methodname + " " + args + "\n";
}
