...
QFontDatabase::addApplicationFont(":/fonts/kfx_font");

QString windowTitle = tr("KnoxFS Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a KnoxFS address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and KnoxFS: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About KnoxFS Core"), this);
    aboutAction->setStatusTip(tr("Show information about KnoxFS Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for KnoxFS"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your KnoxFS addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified KnoxFS addresses"));
    ...
    openAction->setStatusTip(tr("Open a KnoxFS: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the KnoxFS Core help message to get a list with possible KnoxFS command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("KnoxFS Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to KnoxFS network", "", count));
}
...
{
    QString strTitle = tr("KnoxFS Core"); // default title
