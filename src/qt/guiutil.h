...
/** Utility functions used by the KnoxFS Qt UI.
 */
namespace GUIUtil
{
...
// Render KnoxFS addresses in monospace font
...
// Parse "kfx:" URI into recipient object, return true on successful parsing
