...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("KnoxFS Core kfx-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  kfx-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded KnoxFS transaction") + "\n" +
                               "  kfx-tx [options] -create [commands]   " + _("Create hex-encoded KnoxFS transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded KnoxFS transaction
