...
/* *** BEGIN OBFUSCATION MAGIC - KnoxFS **********
    ...
    if (fMasterNode) {
        ...
        for (const CTransaction& txCollateral : vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat KnoxFS and make it unusable. To
                stop these kinds of attacks 1 in 10 successful transactions are charged. This
                adds up to a cost of 0.001 KnoxFS per transaction on average.
            */
            if (r <= 10) {
...
void CObfuscationPool::GetDenominationsToString(int nDenom, std::string& strDenom)
{
    ...
    //
    // bit 0 - 100KnoxFS+1 ( bit on if present )
    // bit 1 - 10KnoxFS+1
    // bit 2 - 1KnoxFS+1
    // bit 3 - .1KnoxFS+1
    // bit 3 - non-denom
