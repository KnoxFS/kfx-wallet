...
* WebSocket: [https://github.com/KnoxFS-Core/insight-api-kfx#web-socket-api](https://github.com/KnoxFS-Core/insight-api-kfx#web-socket-api)
* API: [https://github.com/KnoxFS-Core/insight-api-kfx#swifttx-transactions](https://github.com/KnoxFS-Core/insight-api-kfx#swifttx-transactions)
...
By default, the KnoxFS Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the KnoxFS Core daemon:
