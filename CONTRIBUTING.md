Contributing to KnoxFS Core
============================

The KnoxFS Core project operates an open contributor model where anyone is
...
The following applies to code changes to the KnoxFS Core project, and is not to be
confused with overall KnoxFS Network Protocol consensus changes.

Whether a pull request is merged into KnoxFS Core rests with the project merge
...
Patches that change KnoxFS consensus rules are considerably more involved than
...
Where a patch set proposes to change the KnoxFS consensus, it must have been
...
The project leader is the release manager for each KnoxFS Core release.
