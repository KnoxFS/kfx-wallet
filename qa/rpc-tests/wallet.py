...
#   c) node1 mines 32 blocks, so now node 0 has 60001kfx, node 1 has 4250kfx, node2 has none.
#   d) node0 sends 601 kfx to node2, in two transactions (301 kfx, then 300 kfx).
